 ...
 */
public class DefaultLoggerProviderFinder implements LoggerProviderFinder {

    private static class Holder {
        private static final DefaultLoggerProviderFinder INSTANCE = new DefaultLoggerProviderFinder();
    }

    private final LoggerProvider provider;

    private DefaultLoggerProviderFinder() {
        provider = findProvider();
    }

    public static DefaultLoggerProviderFinder getInstance() {
        return Holder.INSTANCE;
    }

    @Override
    public LoggerProvider find() {
        return provider;
    }
